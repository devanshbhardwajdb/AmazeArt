...
const LoadingContainer2 = () => {
  return (
    <div className="feedcontainer  h-[70vh] bg-white/5 backdrop-blur-md glassmorphism bg-gray-600 rounded-lg flex flex-col gap-6 font-noto w-full animate-pulse duration-75 justify-between ">
