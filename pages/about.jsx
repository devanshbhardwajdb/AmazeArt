    ...
    const About = () => {
        return (
            <div id="about" className='px-[8vw] py-[10vh] gap-8 flex items-center flex-col font-belleza text-white justify-center relative'>
                ...
                <div className="flex items-center justify-center flex-col gap-10 ">
                    ...
                    <div className='relative max-xl:w-3/4  max-lg:w-[70vw] max-md:pt-10'>
                        <motion.div
                            ...
                            whileInView="show"
                            viewport={{ once: false, amount: 0.9 }}
                            className='absolute -left-16 -top-10 max-md:-left-4 max-md:-top-4'>

                            <BiSolidQuoteSingleLeft
                                className='text-7xl max-lg:text-5xl'
                            />
                        ...
                        <motion.h4
                            ...
                            whileInView="show"
                            viewport={{ once: false, amount: 0.9 }}
                            className='text-2xl text-center relative max-lg:text-lg max-md:text-sm'>
                        ...
                        <motion.div
                            ...
                            whileInView="show"
                            viewport={{ once: false, amount: 0.9 }}
                            className='absolute -right-16 -bottom-10 max-md:-right-4 max-md:-bottom-8 '>
