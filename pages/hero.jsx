                ...
                <div className='flex flex-col items-center   xl:w-1/2'>
                    ...
                    <motion.div className="flex relative ">
                        <motion.h1
                            ...
                            className='font-metal text-[20vh] max-xl:text-[18vh] max-lg:text-[10vh] max-md:text-[8vh] text_main pl-5 backdrop  ' >Amaze</motion.h1>
                        <motion.h1
                            variants={slideIn3('left', "tween", 0, 1.0)}
                            initial="hidden"
                            whileInView="show"
                            viewport={{ once: false, amount: 0.9 }}
                            className='font-metal absolute text-[20vh] max-xl:text-[18vh] max-lg:text-[10vh] max-md:text-[8vh] opacity-10  pl-5 z-[-1] text-shadow' >Amaze</motion.h1>
                        <motion.h1
                            variants={slideIn3('right', "tween", 0, 1.0)}
                            initial="hidden"
                            whileInView="show"
                            viewport={{ once: false, amount: 0.9 }}
                            className='font-metal text-[20vh] max-xl:text-[18vh] max-md:text-[8vh] max-lg:text-[10vh] text-white px-5 text-shadow '>Art</motion.h1>
                    </motion.div>
                    ...
                    <motion.h2
                        ...
                        whileInView="show"
                        viewport={{ once: false, amount: 0.9 }}
                        className='font-swash  text-white text-[6vh] max-xl:text-[4vh] max-lg:text-[2.4vh] max-md:text-[1.5vh] text-shadow'>A Unified Solution for all Artists !</motion.h2>
